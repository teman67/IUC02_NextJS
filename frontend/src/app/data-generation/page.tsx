    ...
    <div className="max-w-7xl mx-auto animate-fade-in">
      ...
      <div className="card bg-gradient-to-br from-blue-50 to-indigo-50 mb-8">
        <div className="space-y-4 text-gray-700">
          <p className="text-lg">
            ...
            represents how you can prepare the resources needed to validate your
            Data Graph.
          </p>

          <div className="space-y-3 bg-white p-4 rounded-lg shadow-soft">
            <div className="flex items-start gap-3">
              <span className="bg-primary-500 text-white font-bold px-3 py-1 rounded-full text-sm">
                1
              </span>
              <p>
                <strong>Download your data</strong> from the repository. The
                demonstrator shows the <em>Creep Experiment Input File</em>,
                downloaded from{" "}
                <a
                  href="https://zenodo.org/records/13937987"
                  target="_blank"
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="mb-2">
                  <strong>Populate the JSON Metadata Schema</strong> with data
                  from your Input file. This step requires:
                </p>
                <ul className="list-disc pl-8 space-y-1 text-sm">
                  <li>
                    A <strong>JSON Metadata Schema</strong>
                  </li>
                  <li>
                    A <strong>Mapping Document</strong> to correctly parse the
                    Input data.
                  </li>
                </ul>
                <p className="mt-2 text-sm">
                  The Metadata Schema can be accessed in the{" "}
                  <a
                    href="https://git.rwth-aachen.de/nfdi-matwerk/iuc02/-/tree/main/Data%20Schema"
                    target="_blank"
                    className="text-primary-600 hover:text-primary-800 underline font-semibold"
                  >
                    Git Repository
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="mb-2">
                  <strong>Generate the Populated Data Graph (RDF-Graph)</strong>{" "}
                  from the Populated Metadata Schema using Ontology entities.
                </p>
                <ul className="list-disc pl-8 text-sm">
                  <li>
                    This step requires an <strong>Ontology</strong>, which can
                    be accessed in the same{" "}
                    <a
                      href="https://git.rwth-aachen.de/nfdi-matwerk/iuc02/-/tree/main/Ontology%20Development"
                      target="_blank"
                      className="text-primary-600 hover:text-primary-800 underline font-semibold"
                    >
                      Git Repository
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="mb-2">
                  <strong>Validate the Data Graph</strong> against predefined{" "}
                  <strong>SHACL Shapes</strong> to ensure:
                </p>
                <ul className="list-disc pl-8 space-y-1 text-sm">
                ...
                <p className="mt-2 text-sm">
                  The SHACL Shapes can be accessed in the{" "}
                  <a
                    href="https://git.rwth-aachen.de/nfdi-matwerk/iuc02/-/tree/main/Data%20Validation"
                    target="_blank"
                    className="text-primary-600 hover:text-primary-800 underline font-semibold"
                  >
                    Git Repository
          ...
          <p className="text-lg font-semibold text-primary-800">
            The <strong>output of the Validation Process</strong> is the{" "}
      ...
      <div className="card mb-8">
        ...
        <div className="flex justify-center gap-4 mb-6 flex-wrap">
          ...
          <div className="bg-gradient-to-br from-primary-600 to-primary-700 text-white p-4 rounded-xl w-48 flex items-center justify-center shadow-medium hover:shadow-hard transition-all hover:-translate-y-1">
            <Image
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTm8U7AGVOvLM-YbLe8fGD8cfqXmXQSY7umTQ&s"
              alt="RDF"
              width={40}
              height={40}
              className="mr-2"
          ...
          <div className="bg-gradient-to-br from-dark-600 to-dark-700 text-white p-4 rounded-xl w-48 flex items-center justify-center shadow-medium hover:shadow-hard transition-all hover:-translate-y-1">
            <Image
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQUjbiGuDUs4poajSf5Uw-ePPQFlvaPiyNX7Q&s"
              alt="SHACL"
              width={40}
              height={40}
              className="mr-2"
        ...
        <div className="flex justify-center items-center gap-4 flex-wrap">
          <div className="bg-gradient-to-br from-blue-100 to-blue-200 p-4 rounded-xl w-52 text-center border-2 border-blue-300 shadow-soft hover:shadow-medium transition-all">
            <Image
              src="https://static.thenounproject.com/png/2952643-200.png"
              alt="Input"
              width={40}
              height={40}
            ...
            <strong className="text-gray-800">
              Creep experiment input file (.lis file)
            </strong>
          </div>

          <div className="text-4xl font-bold text-primary-600 animate-bounce-subtle">
            →
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-200 to-blue-300 p-4 rounded-xl w-52 text-center border-2 border-blue-400 shadow-soft hover:shadow-medium transition-all">
            <Image
              src="https://res.cloudinary.com/dlthn5m1i/image/upload/v1742823071/JSON_schema_xlril2.png"
              alt="JSON"
              width={80}
              height={30}
              className="mx-auto mb-2"
          ...
          <div className="bg-gradient-to-br from-blue-400 to-blue-500 p-4 rounded-xl w-52 text-center border-2 border-blue-600 shadow-soft hover:shadow-medium transition-all">
            <Image
              src="https://cdn-icons-png.freepik.com/512/5531/5531412.png"
              alt="Validation"
              width={60}
              height={60}
              className="mx-auto mb-2"
      ...
      <div className="mt-8 bg-gradient-to-r from-yellow-50 to-amber-50 border-l-4 border-amber-400 p-6 rounded-xl shadow-soft">
        <p className="text-lg flex items-center gap-3">
          ...
          <span>
            <strong>Next Step:</strong> Please continue with the{" "}
            <a
              href="/data-validation"
              className="text-primary-700 hover:text-primary-900 underline font-bold"
            >
              Data Validation Workflow
            </a>{" "}
            to see more details on the SHACL Shapes and the Protocol.
          </span>
        </p>
      </div>
    </div>
